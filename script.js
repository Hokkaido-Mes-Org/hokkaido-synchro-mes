...
document.addEventListener('DOMContentLoaded', function() {
    ...
    _fb('getGroupedLossReasons', function() {
        ...
        return { "PROCESSO":["FALHA DE INJEÇÃO","CONTAMINAÇÃO","PONTO ALTO DE INJEÇÃO / FIAPO","REBARBA","FORA DE COR","FORA DE DIMENSIONAL","REINICIO/INICIO","CHUPAGEM","BOLHA","QUEIMA","MANCHAS","JUNÇÃO","EMPENAMENTO","PEÇAS SCRAP","PEÇAS DEFORMADAS"],"FERRAMENTARIA":["GALHO PRESO","MARCA D'AGUA","MARCA DE EXTRATOR","RISCO","SUJIDADE MOLDE","LAMINA QUEBRADA","TRY OUT","LIMPEZA DE TIPS","ABERTURA DE CAVIDADES"],"MAQUINA":["QUEDA DE ENERGIA","PARADA EMERGENCIAL","VAZAMENTO DE OLEO","AUSENCIA DE PERIFERICOS","SUJIDADE (GRAXA, AGUA, ETC)"],"MATERIA PRIMA":["MATERIAL NÃO CONFORME"] };
    });
